...
import com.appsdeveloperblog.ws.emailnotification.handler.ProductCreatedEventListener;
import com.appsdeveloperblog.ws.emailnotification.repository.ProcessedEventRepository;

@EmbeddedKafka
@SpringBootTest(properties="spring.kafka.consumer.bootstrap-servers=${spring.embedded.kafka.brokers}")
public class ProductCreatedEventListernerIntegrationTest {
	...
	@SpyBean
	ProductCreatedEventListener productCreatedEventListener;
	...
	public void testProductCreatedEventHandler_OnProductCreated_HandlesEvent() throws Exception{
		...
		verify(productCreatedEventListener, timeout(5000).times(1)).handle(eventCaptor.capture(), 
